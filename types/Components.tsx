...
export const YTextField: React.FC<CustomTextFieldProps> = ({
  ...
  return (
    <div className={`flex flex-col ${className}`}>
      ...
      <input
        {...props}
        className={`h-[30px] w-30 border bg-gray-200 border-gray-300 rounded-md px-3 py-2 text-sm focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500 `}
      />
      {error && (
